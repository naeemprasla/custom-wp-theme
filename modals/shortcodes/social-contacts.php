...
function get_social_links()
{
    ...
    if (!empty($facebook)) {
        $html .= '<a href="' . $facebook . '" target="_blank"><i class="fab fa-facebook"></i></a>';
    }
    if (!empty($twitter)) {
        $html .= '<a href="' . $twitter . '" target="_blank"><i class="fab fa-twitter"></i></a>';
    }
    if (!empty($linkedin)) {
        $html .= '<a href="' . $linkedin . '" target="_blank"><i class="fab fa-linkedin"></i></a>';
    }
    if (!empty($instagram)) {
        $html .= '<a href="' . $instagram . '" target="_blank"><i class="fab fa-instagram"></i></a>';
    }
    if (!empty($youtube)) {
        $html .= '<a href="' . $youtube . '" target="_blank"><i class="fab fa-youtube"></i></a>';
    }
